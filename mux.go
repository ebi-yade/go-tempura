...
// map[Prefix]any の any として渡す関数は、FuncXXXX によって生成された ReturningAnyXXXX 型であることが期待されています。
...
// The function passed as any in map[Prefix]any is expected to be of type ReturningAnyXXXX generated by FuncXXXX.
